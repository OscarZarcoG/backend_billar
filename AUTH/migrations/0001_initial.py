# Generated by Django 4.2.16 on 2025-12-01 05:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_profile', models.ImageField(blank=True, null=True, upload_to='profile_pictures/', verbose_name='Profile Picture')),
                ...
                ('role', models.CharField(choices=[('root', 'Root'), ('admin', 'Administrator'), ('client', 'Client')], db_index=True, default='client', max_length=50, verbose_name='Role')),
